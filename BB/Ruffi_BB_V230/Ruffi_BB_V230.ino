...
void loop() {
  ...
  */
  ...
  vel = (P * 0.17) + (D * 0.955) + (I * 0.01 ); //GODDDDDDDDDDDDDDDDDDDDDDDD
  //vel = (P * 0.12) + (D * 0.955) + (I * 0.01 );
  //vel = (P * 0.21) + (D * 0.965) + (I * 0.01 );
  //vel = (P * 0.2) + (D * 0.955) + (I * 0.01 );
  //vel = (P * 0.13) + (D * 0.99) + (I * 0.01 );
  //vel = (P * 0.13) + (D * 0.955) + (I * 0.01 );EXCELENTEEEEEEE
  //vel = (P * 0.2) + (D * 0.955) + (I * 0.01 );
