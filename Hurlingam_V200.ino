...
void loop() {
  ...
  */
  ...
  //1vel = (P * 0.25) + (D * 0.8) + (I * 0.01 );  //NI GIRÓ
  //2vel = (P * 0.20) + (D * 0.955) + (I * 0.01 ); //GIRÓ ABIERTO
  //3vel = (P * 0.21) + (D * 0.955) + (I * 0.01 ); //MUY BIEN UN POQUITITITITO ABIERTO
  //vel = (P * 0.205) + (D * 0.955) + (I * 0.01 );
  //vel = (P * 0.215) + (D * 0.955) + (I * 0.01 ); //MEJOR QUE 3
  vel = (P * 0.217) + (D * 0.955) + (I * 0.01 ); //EXCELENTE, CAMBIARÍA KD
  //vel = (P * 0.22) + (D * 0.950) + (I * 0.01 ); //SE FUE DE LA PISTA
