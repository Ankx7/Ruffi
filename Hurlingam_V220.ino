...
void loop() {
  ...
  */
  ...
  //1vel = (P * 0.25) + (D * 0.8) + (I * 0.01 ); //SE FUE
  //2vel = (P * 0.20) + (D * 0.955) + (I * 0.01 ); //GIRÓ ABIERTO
  //3vel = (P * 0.21) + (D * 0.955) + (I * 0.01 ); //GIRÓ ABIERTO
  //vel = (P * 0.205) + (D * 0.955) + (I * 0.01 ); //GIRÓ ABIERTO
  //vel = (P * 0.215) + (D * 0.955) + (I * 0.01 ); //GIRÓ ABIERTO
  //vel = (P * 0.21) + (D * 1) + (I * 0.01 ); //MEJOR
  vel = (P * 0.21) + (D * 1.0075) + (I * 0.01 );
  //vel = (P * 0.217) + (D * 0.955) + (I * 0.01 ); 
  //vel = (P * 0.22) + (D * 0.950) + (I * 0.01 );
  //vel = (P * 0.24) + (D * 0.9) + (I * 0.01 );
  // vel = (P * 0.26) + (D * 0.85) + (I * 0.01 );

   //vel = (P * 0.28) + (D * 0.25) + (I * 0.01 );
   //vel = (P * 0.3) + (D * 0.6) + (I * 0.01 );
