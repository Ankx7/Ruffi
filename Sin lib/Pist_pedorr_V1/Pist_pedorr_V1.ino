...
*/
  ...
  Serial.print("MotA: " + String(pwmA) + "  MotB: " + String(pwmB) + "  ERROR: " + String(error) + "  pd : " + String(pd) + "  d : " + String(d *0.004));
...
void pdError() {
  ...
  if (count_sens == 0) {  //xq sino da indeterminación 0/0
    ...
    error = (-600 * qtr_detect[0]) + (-400 * qtr_detect[1]) + (-200 * qtr_detect[2]) + (0 * qtr_detect[3]) + (200 * qtr_detect[4]) + (400 * qtr_detect[5]) + (600 * qtr_detect[6]);  //modificar suma según cant sens
